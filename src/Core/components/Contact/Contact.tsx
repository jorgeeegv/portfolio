            ...
            <form onSubmit={handleSubmit(onSubmit)} ref={(e) => { form.current = e}}>
                <div className="pb-12 w-full">
                    ...
                    <div className="mt-10 flex flex-col w-full gap-y-5">
                        <div className="">
                            <label htmlFor="first-name" className={(errors.user_name ? 'color-danger' : '') + " block pl-1 text-1xl font-semibold color-primary hidden-right-1"}>
                            ...
                            <div className="mt-2">
                                <input
                                    type="text"
                                    id="user_name"
                                    className={(errors.user_name ? 'error-input' : '') + " primary-input block w-full rounded-md py-1.5 sm:text-sm sm:leading-6 hidden-right-1"}
                        ...
                        <div className="">
                            <label htmlFor="email" className={(errors.user_email ? 'color-danger' : '') + " block text-1xl font-semibold color-primary hidden-right-2"}>
                                Email
                            </label>
                            <div className="mt-2">
                                <input
                                    ...
                                    id="user_email"
                                    className={(errors.user_email ? 'error-input' : '') + " primary-input block w-full rounded-md border-0 py-1.5  sm:text-sm sm:leading-6 hidden-right-2"}
                        ...
                        <div className="">
                            <label htmlFor="user_message" className={"block text-1xl font-semibold color-primary hidden-right-3"}>
                            {t("contact.label.message")}
                            </label>
                            <div className="mt-2">
                                <textarea placeholder='Escribe algo...'
                                    {...register("user_message", {disabled: blockForm})}
                                    className={(errors.user_message ? 'error-input' : '') + " primary-input block w-full rounded-md  sm:text-sm sm:leading-6 hidden-right-3"}></textarea>
                                {errors.user_message && <small role='alert' className='color-danger'>{errors.user_message.message?.toString()}</small>}
                            </div>
                        </div>
                    </div>
                </div>
                <div className='w-80 lg:w-full mx-auto hidden-right-3'>

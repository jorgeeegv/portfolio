        ...
        <div className="w-full my-56 lg:my-64 flex gap-x-20 grid grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-1">
            ...
            <div className="col-span-1 w-full grid grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-1">
                <div className='flex flex-col lg:gap-5'>
                    <div>
                        <div className="text-2xl text-center py-5 lg:text-start lg:p-0 font-bold color-primary">SOBRE MI</div>
                    </div>
                    <div className='inline-block text-1xl font-semibold subtitle-text text-center lg:text-start '>
                        <span>

...
export default function AboutMe() {
    ...
    return (
        <div id='about' className="w-full mt-60 mb-56 lg:my-64 gap-y-10 flex gap-x-20 grid grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-1">
            <div className="col-span-1 flex justify-center lg:justify-end items-end lg:w-full lg:h-full">
                ...
                <img className="hidden md:flex lg:flex img-about-me deep-effect" src={process.env.PUBLIC_URL + '/imgs/jorge.jpg'} />
            </div>

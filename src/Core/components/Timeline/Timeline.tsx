    ...
    return (
        <div className="flex w-full my-40">
            <div className="flex flex-col w-full justify-center items-center">
                ...
                <div className="flex flex-col lg:flex-row w-full justify-start lg:justify-center items-center y-20 grid grid-cols-5 grid-rows-1 lg:grid-cols-1 grid-rows-2">
